...
class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.MovieViewHolder> {
     ...
     *
     * @param movieEntityData The new movie data to be displayed.
     */
    void setMovieData(List<MovieEntity> movieEntityData) {
        if (mMoviesList == null) {
            mMoviesList = movieEntityData;
    ...
    public void onBindViewHolder(@NonNull final MovieAdapter.MovieViewHolder holder, int position) {
        ...
        holder.mTitleTextView.setText(movieEntity.getTitle());
        Picasso.get().load(movieEntity.getImageView()).into(holder.mPosterImageView);
    }
